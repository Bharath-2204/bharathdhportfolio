...
export const SkillBadge = ({ icon: Icon, name, level }: SkillBadgeProps) => {
  return (
    <div className="group flex flex-col items-center gap-3 p-4 bg-card border border-border rounded hover:border-primary transition-all duration-300 hover:shadow-[0_0_15px_hsl(var(--cyber-accent)/0.2)]">
